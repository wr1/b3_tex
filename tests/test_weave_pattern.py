...
def test_woven_yarns_warp_weft_symmetry_and_local_vf():
    ...
    geom = WeaveGeometry(domain_size=size, warp_width=0.004, warp_height=0.0008,
                         power=4.0, compaction=0.3, nest=True, nominal_vf=0.55, max_vf=0.9)
...
@pytest.mark.parametrize("name", ["weave_twill_2x2", "weave_satin_4h", "weave_basket_2x2"])
